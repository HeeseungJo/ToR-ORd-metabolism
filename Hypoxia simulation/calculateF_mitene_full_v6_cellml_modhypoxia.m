...
function [dCam, dADPm, dDpsi, dSCoA, dNADH, dISOC, dAKG, dSucc, dFUM, dMAL, dOaa, dASP, dATPi, dATPi_cyto, dCrPi_mito, dCrPi_cyto, dP0, dP1, dP2, dP3, dN1, dLTRPNCa, dHTRPNCa, force_norm, force, VNO] ...
    = calculateF_mitene_full_v6_cellml_modhypoxia(Cam, ADPm, Dpsi, SCoA, NADH, ISOC, AKG, Succ, FUM, MAL, Oaa, ASP, ATPi, ATPi_cyto, CrPi_mito, CrPi_cyto, P0, P1, P2, P3, N1, LTRPNCa, HTRPNCa, Cai, Nai, Jup, INaK, IpCa)
    ...
    n = 6; % dimensionless, NCX antiporter cooperativity
    ...
    % DPsi VHNe
    rhoREN = 1.01e-1 * 0.005; % mM Conc of electron carriers 1.01e-1 in cellml %%%%%%%% Moderate Hypoxia 0.5% O2 %%%%%%%%%%%%%%%
    ...
    % Dpsi VHFe
    rhoREF = 3.75e-4* 0.005; % mM Conc of electron carriers (II, III, IV) %%%%%%%% Moderate Hypoxia 0.5% O2 %%%%%%%%%%%%%%%
