...
function output=model_Torord_withmito_v6_normoxia(t,X,flag_ode, cellType, ICaL_Multiplier, ...
...
[dCam, dADPm, dDpsi, dSCoA, dNADH, dISOC, dAKG, dSucc, dFUM, dMAL, dOaa, dASP, dATPi, dATPi_cyto, dCrPi_mito, dCrPi_cyto, dP0, dP1, dP2, dP3, dN1, dLTRPNCa, dHTRPNCa, force_norm, force, VNO]  ...
    = calculateF_mitene_full_v6_cellml_normoxia(Cam, ADPm, Dpsi, SCoA, NADH, ISOC, AKG, Succ, FUM, MAL, Oaa, ASP, ATPi, ATPi_cyto, CrPi_mito, CrPi_cyto, P0, P1, P2, P3, N1, LTRPNCa, HTRPNCa, Cai, Nai, Jup_cortassa_scalar, INaK_cortassa_scalar, IpCa_cortassa_scalar);
